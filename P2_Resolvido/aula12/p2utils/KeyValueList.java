...
public class KeyValueList<E> {
  ...
  public String toString(String left, String sep, String right) {
    return left + toString(first, sep) + right;
  }
  
  private String toString (KeyValueNode n, String sep){
	  if(n==null) return "";
	  if(n.next==null) sep = "";
	  return "(" + n.key + ", " + n.elem.toString() + ")" + sep + toString(n.next, sep);
  }
